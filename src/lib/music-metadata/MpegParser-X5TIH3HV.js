import { g as getBitAllignedNumber, U as UINT32_BE, a as UINT16_BE, b as UINT8, S as StringType, i as isBitSet, E as EndOfStreamError, I as INT16_BE, c as Uint8ArrayType, s as stripNulls, d as initDebug, m as makeUnexpectedFileContentError } from './index-DKps7p52.js';
...
class MpegParser extends AbstractID3Parser {
    ...
    async parseCrc() {
        await this.tokenizer.ignore(INT16_BE.len); // Ignore CRC
...
export { MpegContentError, MpegParser };
