...
function EntityNode(props: { $: ObjectNode; customRenderer?: CustomRenderer }) {
	return (
		<Switch
			fallback={
				<Dynamic
...
export function ModifyString(props: { text: string }) {
...
function Entity(props: { $: Node; customRenderer?: CustomRenderer }) {
	return (
		<Show
			when={typeof props.$ == "string"}
			fallback={<EntityNode $={props.$ as ObjectNode} customRenderer={props.customRenderer} />}
		>
			<ModifyString text={props.$ as string} />
		</Show>
	);
}
