...
'messageActionStarGiftUnique':function(w,v){w.uint(2115768711);var flags=0;if(v.upgrade===true)flags|=1;if(v.transferred===true)flags|=2;if(v.saved===true)flags|=4;var _canExportAt=v.canExportAt!==undefined;if(_canExportAt)flags|=8;var _transferStars=v.transferStars!==undefined;if(_transferStars)flags|=16;if(v.refunded===true)flags|=32;var _fromId=v.fromId!==undefined;if(_fromId)flags|=64;var _peer=v.peer!==undefined;var _savedId=v.savedId!==undefined;var _flags_7=_peer||_savedId;if(_flags_7)flags|=128;var _resaleAmount=v.resaleAmount!==undefined;if(_resaleAmount)flags|=256;var _canTransferAt=v.canTransferAt!==undefined;if(_canTransferAt)flags|=512;var _canResellAt=v.canResellAt!==undefined;if(_canResellAt)flags|=1024;if(v.prepaidUpgrade===true)flags|=2048;var _dropOriginalDetailsStars=v.dropOriginalDetailsStars!==undefined;if(_dropOriginalDetailsStars)flags|=4096;if(v.assigned===true)flags|=8192;if(v.fromOffer===true)flags|=16384;var _canCraftAt=v.canCraftAt!==undefined;if(_canCraftAt)flags|=32768;if(v.craft===true)flags|=65536;if(v.nameHidden===true)flags|=131072;var _message=v.message!==undefined;if(_message)flags|=262144;w.uint(flags);w.object(h(v,'gift'));if(_canExportAt)w.int(v.canExportAt);if(_transferStars)w.long(v.transferStars);if(_fromId)w.object(v.fromId);if(_flags_7)w.object(v.peer);if(_flags_7)w.long(v.savedId);if(_resaleAmount)w.object(v.resaleAmount);if(_canTransferAt)w.int(v.canTransferAt);if(_canResellAt)w.int(v.canResellAt);if(_dropOriginalDetailsStars)w.long(v.dropOriginalDetailsStars);if(_canCraftAt)w.int(v.canCraftAt);if(_message)w.object(v.message);},
...
'messageActionChangeCommunity':function(w,v){w.uint(1562426088);var flags=0;var _communityId=v.communityId!==undefined;if(_communityId)flags|=1;w.uint(flags);if(_communityId)w.int53(v.communityId);},
'messageActionChatJoinedViaCommunity':function(w,v){w.uint(1250688640);w.int53(h(v,'communityId'));},
...
'dialogCommunity':function(w,v){w.uint(4153018739);var flags=0;if(v.pinned===true)flags|=4;w.uint(flags);w.int53(h(v,'communityId'));w.object(h(v,'notifySettings'));},
...
'inputNotifyCommunity':function(w,v){w.uint(666573532);w.object(h(v,'community'));},
...
'updateNewEphemeralMessage':function(w,v){w.uint(549239713);w.object(h(v,'message'));},
'updateDeleteEphemeralMessages':function(w,v){w.uint(1457257720);w.object(h(v,'peer'));w.vector(w.int,h(v,'ids'));},
'updateEditEphemeralMessage':function(w,v){w.uint(1270583041);w.object(h(v,'message'));},
'updateEphemeralBotCallbackQuery':function(w,v){w.uint(2081454550);var flags=0;var _peer=v.peer!==undefined;if(_peer)flags|=1;var _chatInstance=v.chatInstance!==undefined;if(_chatInstance)flags|=2;w.uint(flags);w.long(h(v,'queryId'));w.int53(h(v,'userId'));if(_peer)w.object(v.peer);w.int(h(v,'msgId'));w.bytes(h(v,'data'));if(_chatInstance)w.long(v.chatInstance);w.object(h(v,'message'));},
'updateBotStarsSubscription':function(w,v){w.uint(1812827683);var flags=0;if(v.canceled===true)flags|=1;if(v.paymentFailed===true)flags|=2;if(v.restored===true)flags|=4;w.uint(flags);w.int53(h(v,'userId'));w.bytes(h(v,'payload'));w.int(h(v,'qts'));},
...
'notifyCommunity':function(w,v){w.uint(3191302553);w.int53(h(v,'communityId'));},
...
'sendMessageTextDraftAction':function(w,v){w.uint(909162586);var flags=0;if(v.canStop===true)flags|=1;if(v.keepOnStop===true)flags|=2;w.uint(flags);w.long(h(v,'randomId'));w.object(h(v,'text'));},
'inputSendMessageRichMessageDraftAction':function(w,v){w.uint(2839005118);var flags=0;if(v.canStop===true)flags|=1;if(v.keepOnStop===true)flags|=2;w.uint(flags);w.long(h(v,'randomId'));w.object(h(v,'richMessage'));},
'sendMessageRichMessageDraftAction':function(w,v){w.uint(1381386387);var flags=0;if(v.canStop===true)flags|=1;if(v.keepOnStop===true)flags|=2;w.uint(flags);w.long(h(v,'randomId'));w.object(h(v,'richMessage'));},
'sendMessageStopDraftAction':function(w,v){w.uint(4227400368);w.long(h(v,'randomId'));},
...
'botCommand':function(w,v){w.uint(2555565778);var flags=0;if(v.ephemeral===true)flags|=1;w.uint(flags);w.string(h(v,'command'));w.string(h(v,'description'));},
...
'keyboardButton':function(w,v){w.uint(795322159);var flags=0;var _style=v.style!==undefined;if(_style)flags|=1024;w.uint(flags);if(_style)w.object(v.style);w.string(h(v,'text'));w.object(h(v,'type'));},
...
'replyKeyboardMarkup':function(w,v){w.uint(2245892561);var flags=0;if(v.resize===true)flags|=1;if(v.singleUse===true)flags|=2;if(v.selective===true)flags|=4;var _placeholder=v.placeholder!==undefined;if(_placeholder)flags|=8;if(v.persistent===true)flags|=16;if(v.forceReply===true)flags|=32;w.uint(flags);w.vector(w.object,h(v,'rows'));if(_placeholder)w.string(v.placeholder);},
'replyInlineMarkup':function(w,v){w.uint(2997966704);var flags=0;if(v.forceReply===true)flags|=32;w.uint(flags);w.vector(w.object,h(v,'rows'));},
...
'textDiff':function(w,v){w.uint(2525416272);w.object(h(v,'text'));w.object(h(v,'oldText'));},
'textButton':function(w,v){w.uint(2949094614);var flags=0;var _style=v.style!==undefined;if(_style)flags|=1;w.uint(flags);w.object(h(v,'text'));w.object(h(v,'type'));if(_style)w.object(v.style);},
...
'pageBlockBlockquote':function(w,v){w.uint(1724999435);var flags=0;if(v.collapsed===true)flags|=1;w.uint(flags);w.object(h(v,'text'));w.object(h(v,'caption'));},
...
'pageBlockTable':function(w,v){w.uint(3209554562);var flags=0;if(v.bordered===true)flags|=1;if(v.striped===true)flags|=2;if(v.compact===true)flags|=4;w.uint(flags);w.object(h(v,'title'));w.vector(w.object,h(v,'rows'));},
...
'pageBlockButtonRow':function(w,v){w.uint(1835270936);var flags=0;if(v.alignLeft===true)flags|=1;if(v.alignCenter===true)flags|=2;if(v.alignRight===true)flags|=4;w.uint(flags);w.vector(w.object,h(v,'buttons'));},
'pageBlockDocument':function(w,v){w.uint(955923363);w.long(h(v,'documentId'));w.object(h(v,'caption'));},
...
'inputDialogPeerCommunity':function(w,v){w.uint(1777300164);w.object(h(v,'community'));},
...
'dialogPeerCommunity':function(w,v){w.uint(795199716);w.int53(h(v,'communityId'));},
...
'inputInvoiceStarGiftResale':function(w,v){w.uint(3920676440);var flags=0;if(v.ton===true)flags|=1;var _message=v.message!==undefined;if(_message)flags|=2;if(v.showName===true)flags|=4;w.uint(flags);w.string(h(v,'slug'));w.object(h(v,'toId'));if(_message)w.object(v.message);},
...
'inputReplyToEphemeralMessage':function(w,v){w.uint(1092204894);w.int(h(v,'id'));},
...
'inputAiComposeToneSingleUse':function(w,v){w.uint(235681199);w.string(h(v,'customPrompt'));},
...
'messages.chatInviteJoinResultWebView':function(w,v){w.uint(1640638931);w.int53(h(v,'botId'));w.long(h(v,'queryId'));w.vector(w.object,h(v,'users'));},
...
'communityPeer':function(w,v){w.uint(1981030077);var flags=0;var _visible=v.visible!==undefined;if(_visible)flags|=1;if(v.canViewHistory===true)flags|=4;w.uint(flags);if(_visible)w.boolean(v.visible);w.object(h(v,'peer'));},
'communityPeerRequest':function(w,v){w.uint(2078997125);var flags=0;if(v.visible===true)flags|=1;w.uint(flags);w.object(h(v,'peer'));w.int53(h(v,'requestedBy'));w.int(h(v,'date'));},
'communities.peerLinkRequests':function(w,v){w.uint(574926765);var flags=0;var _nextOffset=v.nextOffset!==undefined;if(_nextOffset)flags|=1;w.uint(flags);w.int(h(v,'totalCount'));w.vector(w.object,h(v,'requests'));if(_nextOffset)w.string(v.nextOffset);w.vector(w.object,h(v,'chats'));w.vector(w.object,h(v,'users'));},
'ephemeralMessage':function(w,v){w.uint(3710369513);var flags=0;if(v.out===true)flags|=1;var _topMsgId=v.topMsgId!==undefined;if(_topMsgId)flags|=2;var _entities=v.entities&&v.entities.length;if(_entities)flags|=4;var _media=v.media!==undefined;if(_media)flags|=8;var _replyMarkup=v.replyMarkup!==undefined;if(_replyMarkup)flags|=16;if(v.welcomeTemplate===true)flags|=32;var _replyTo=v.replyTo!==undefined;if(_replyTo)flags|=64;if(v.invertMedia===true)flags|=128;var _richMessage=v.richMessage!==undefined;if(_richMessage)flags|=256;var _peerId=v.peerId!==undefined;if(_peerId)flags|=512;var _chatInstance=v.chatInstance!==undefined;if(_chatInstance)flags|=1024;var _anchorMsgId=v.anchorMsgId!==undefined;if(_anchorMsgId)flags|=2048;if(v.noforwards===true)flags|=4096;w.uint(flags);w.int(h(v,'id'));w.object(h(v,'fromId'));if(_peerId)w.object(v.peerId);w.int53(h(v,'receiverId'));if(_topMsgId)w.int(v.topMsgId);w.int(h(v,'date'));w.string(h(v,'message'));if(_entities)w.vector(w.object,v.entities);if(_media)w.object(v.media);if(_replyMarkup)w.object(v.replyMarkup);if(_replyTo)w.object(v.replyTo);if(_richMessage)w.object(v.richMessage);if(_chatInstance)w.long(v.chatInstance);if(_anchorMsgId)w.int(v.anchorMsgId);},
'communities.participantJoinedChats':function(w,v){w.uint(2373472554);w.vector(w.int53,h(v,'creatorChatIds'));w.vector(w.int53,h(v,'joinedChatIds'));w.vector(w.object,h(v,'chats'));w.vector(w.object,h(v,'users'));},
'messages.translatedRichMessage':function(w,v){w.uint(1107532175);w.vector(w.object,h(v,'result'));},
'messages.composedRichMessageWithAI':function(w,v){w.uint(1279604680);w.object(h(v,'result'));},
'buttonTypeDefault':function(w){w.uint(3386740969);},
'buttonTypeRequestPhone':function(w){w.uint(3745330937);},
'buttonTypeRequestGeoLocation':function(w){w.uint(2616123712);},
'buttonTypeRequestPoll':function(w,v){w.uint(2865758084);var flags=0;var _quiz=v.quiz!==undefined;if(_quiz)flags|=1;w.uint(flags);if(_quiz)w.boolean(v.quiz);},
'buttonTypeRequestPeer':function(w,v){w.uint(1331208759);var flags=0;w.uint(flags);w.int(h(v,'buttonId'));w.object(h(v,'peerType'));w.int(h(v,'maxQuantity'));},
'inputButtonTypeRequestPeer':function(w,v){w.uint(1071802622);var flags=0;if(v.nameRequested===true)flags|=1;if(v.usernameRequested===true)flags|=2;if(v.photoRequested===true)flags|=4;w.uint(flags);w.int(h(v,'buttonId'));w.object(h(v,'peerType'));w.int(h(v,'maxQuantity'));},
'buttonTypeSimpleWebView':function(w,v){w.uint(3222952314);w.string(h(v,'url'));},
'inlineButtonTypeUrl':function(w,v){w.uint(3970234580);w.string(h(v,'url'));},
'inlineButtonTypeUrlAuth':function(w,v){w.uint(3218091426);var flags=0;var _fwdText=v.fwdText!==undefined;if(_fwdText)flags|=1;w.uint(flags);if(_fwdText)w.string(v.fwdText);w.string(h(v,'url'));w.int(h(v,'buttonId'));},
'inputInlineButtonTypeUrlAuth':function(w,v){w.uint(2573319348);var flags=0;if(v.requestWriteAccess===true)flags|=1;var _fwdText=v.fwdText!==undefined;if(_fwdText)flags|=2;var _bot=v.bot!==undefined;if(_bot)flags|=4;w.uint(flags);if(_fwdText)w.string(v.fwdText);w.string(h(v,'url'));if(_bot)w.object(v.bot);},
'inlineButtonTypeWebView':function(w,v){w.uint(1003140532);w.string(h(v,'url'));},
'inlineButtonTypeCallback':function(w,v){w.uint(693484600);var flags=0;if(v.requiresPassword===true)flags|=1;w.uint(flags);w.bytes(h(v,'data'));},
'inlineButtonTypeGame':function(w){w.uint(1557360797);},
'inlineButtonTypeBuy':function(w){w.uint(1220204453);},
'inlineButtonTypeSwitchInline':function(w,v){w.uint(2474065909);var flags=0;if(v.samePeer===true)flags|=1;var _peerTypes=v.peerTypes&&v.peerTypes.length;if(_peerTypes)flags|=2;w.uint(flags);w.string(h(v,'query'));if(_peerTypes)w.vector(w.object,v.peerTypes);},
'inlineButtonTypeUserProfile':function(w,v){w.uint(1067663311);w.int53(h(v,'userId'));},
'inputInlineButtonTypeUserProfile':function(w,v){w.uint(1408487002);w.object(h(v,'userId'));},
'inlineButtonTypeCopy':function(w,v){w.uint(3021812338);w.string(h(v,'copyText'));},
'inlineButtonTypeDisabled':function(w){w.uint(2755158429);},
'keyboardInlineButton':function(w,v){w.uint(297902882);var flags=0;var _style=v.style!==undefined;if(_style)flags|=1024;w.uint(flags);if(_style)w.object(v.style);w.string(h(v,'text'));w.object(h(v,'type'));},
'keyboardInlineButtonRow':function(w,v){w.uint(423758582);w.vector(w.object,h(v,'buttons'));},
'richButtonStyle':function(w,v){w.uint(63312061);var flags=0;if(v.bgPrimary===true)flags|=1;if(v.bgDanger===true)flags|=2;if(v.bgSuccess===true)flags|=4;if(v.link===true)flags|=8;w.uint(flags);},
'pageButton':function(w,v){w.uint(1764381832);var flags=0;var _style=v.style!==undefined;if(_style)flags|=1;w.uint(flags);w.object(h(v,'text'));w.object(h(v,'type'));if(_style)w.object(v.style);},
'ephemeral.welcomeMessagesNotModified':function(w){w.uint(1509940017);},
'ephemeral.welcomeMessages':function(w,v){w.uint(273664114);w.long(h(v,'hash'));w.vector(w.object,h(v,'messages'));},
'auth.firebasePnvIntent':function(w,v){w.uint(3747266572);w.string(h(v,'nonce'));w.string(h(v,'digitalCredentialPayload'));},
...
'auth.initFirebasePnvLogin':function(w,v){w.uint(2004743034);w.int(h(v,'apiId'));w.string(h(v,'apiHash'));},
'auth.finishFirebasePnvLogin':function(w,v){w.uint(746916172);w.string(h(v,'googleToken'));},
'auth.firebasePnvSignUp':function(w,v){w.uint(2017422166);var flags=0;if(v.noJoinedNotifications===true)flags|=1;w.uint(flags);w.string(h(v,'firstName'));w.string(h(v,'lastName'));},
...
'messages.searchGlobal':function(w,v){w.uint(1629922364);var flags=0;var _folderId=v.folderId!==undefined;if(_folderId)flags|=1;if(v.broadcastsOnly===true)flags|=2;if(v.groupsOnly===true)flags|=4;if(v.usersOnly===true)flags|=8;var _community=v.community!==undefined;if(_community)flags|=16;w.uint(flags);if(_folderId)w.int(v.folderId);if(_community)w.object(v.community);w.string(h(v,'q'));w.object(h(v,'filter'));w.int(h(v,'minDate'));w.int(h(v,'maxDate'));w.int(h(v,'offsetRate'));w.object(h(v,'offsetPeer'));w.int(h(v,'offsetId'));w.int(h(v,'limit'));},
...
'messages.translateRichMessage':function(w,v){w.uint(441720836);var flags=0;var _peer=v.peer!==undefined;var _id=v.id&&v.id.length;var _flags_0=_peer||_id;if(_flags_0)flags|=1;var _text=v.text&&v.text.length;if(_text)flags|=2;var _tone=v.tone!==undefined;if(_tone)flags|=4;w.uint(flags);if(_flags_0)w.object(v.peer);if(_flags_0)w.vector(w.int,v.id);if(_text)w.vector(w.object,v.text);w.string(h(v,'toLang'));if(_tone)w.string(v.tone);},
'messages.composeRichMessageWithAI':function(w,v){w.uint(2373641903);var flags=0;if(v.proofread===true)flags|=1;var _translateToLang=v.translateToLang!==undefined;if(_translateToLang)flags|=2;var _tone=v.tone!==undefined;if(_tone)flags|=4;if(v.emojify===true)flags|=8;var _text=v.text!==undefined;if(_text)flags|=16;w.uint(flags);if(_text)w.object(v.text);if(_translateToLang)w.string(v.translateToLang);if(_tone)w.object(v.tone);},
'messages.requestChatJoinWebView':function(w,v){w.uint(3130975865);var flags=0;var _themeParams=v.themeParams!==undefined;if(_themeParams)flags|=1;w.uint(flags);w.long(h(v,'queryId'));if(_themeParams)w.object(v.themeParams);w.string(h(v,'platform'));},
...
'channels.getAdminedPublicChannels':function(w,v){w.uint(4172297903);var flags=0;if(v.byLocation===true)flags|=1;if(v.checkLimit===true)flags|=2;if(v.forPersonal===true)flags|=4;if(v.forCommunityPeer===true)flags|=8;w.uint(flags);},
...
'communities.create':function(w,v){w.uint(2788710892);var flags=0;var _about=v.about!==undefined;if(_about)flags|=1;if(v.hidden===true)flags|=2;w.uint(flags);w.string(h(v,'title'));if(_about)w.string(v.about);w.object(h(v,'peer'));},
'communities.togglePeerLink':function(w,v){w.uint(1936576490);var flags=0;if(v.visible===true)flags|=1;if(v.hidden===true)flags|=2;if(v.deleted===true)flags|=4;w.uint(flags);w.object(h(v,'community'));w.object(h(v,'peer'));},
'communities.getJoinedCommunities':function(w){w.uint(2791565360);},
'communities.toggleCommunityCollapsedInDialogs':function(w,v){w.uint(3613844458);var flags=0;if(v.collapsed===true)flags|=1;w.uint(flags);w.object(h(v,'community'));},
'communities.getPeerLinkRequests':function(w,v){w.uint(2474062660);w.object(h(v,'community'));w.string(h(v,'offset'));w.int(h(v,'limit'));},
'communities.togglePeerLinkRequestApproval':function(w,v){w.uint(2357336488);var flags=0;if(v.reject===true)flags|=1;w.uint(flags);w.object(h(v,'community'));w.object(h(v,'peer'));},
'communities.toggleAllPeerLinkRequestApproval':function(w,v){w.uint(3219381565);var flags=0;if(v.reject===true)flags|=1;w.uint(flags);w.object(h(v,'community'));},
'communities.toggleParticipantBanned':function(w,v){w.uint(2573708559);var flags=0;if(v.unban===true)flags|=1;w.uint(flags);w.object(h(v,'community'));w.object(h(v,'participant'));},
'communities.getParticipantJoinedChats':function(w,v){w.uint(4169051051);w.object(h(v,'community'));w.object(h(v,'participant'));},
'ephemeral.sendMessage':function(w,v){w.uint(3129827125);var flags=0;var _queryId=v.queryId!==undefined;if(_queryId)flags|=1;var _entities=v.entities&&v.entities.length;if(_entities)flags|=2;var _media=v.media!==undefined;if(_media)flags|=4;var _replyMarkup=v.replyMarkup!==undefined;if(_replyMarkup)flags|=8;var _richMessage=v.richMessage!==undefined;if(_richMessage)flags|=16;var _replyTo=v.replyTo!==undefined;if(_replyTo)flags|=32;if(v.invertMedia===true)flags|=64;if(v.welcome===true)flags|=128;var _peer=v.peer!==undefined;if(_peer)flags|=256;if(v.anchor===true)flags|=512;if(v.noforwards===true)flags|=1024;w.uint(flags);if(_peer)w.object(v.peer);w.object(h(v,'receiverId'));if(_queryId)w.long(v.queryId);w.string(h(v,'message'));if(_entities)w.vector(w.object,v.entities);if(_media)w.object(v.media);if(_replyMarkup)w.object(v.replyMarkup);if(_richMessage)w.object(v.richMessage);w.long(h(v,'randomId'));if(_replyTo)w.object(v.replyTo);},
'ephemeral.deleteMessage':function(w,v){w.uint(2465654679);var flags=0;var _peer=v.peer!==undefined;if(_peer)flags|=1;w.uint(flags);if(_peer)w.object(v.peer);w.object(h(v,'receiverId'));w.int(h(v,'id'));},
'ephemeral.reportMessage':function(w,v){w.uint(2265248447);w.object(h(v,'peer'));w.int(h(v,'id'));w.bytes(h(v,'option'));w.string(h(v,'message'));},
'ephemeral.getCallbackAnswer':function(w,v){w.uint(1067738312);var flags=0;var _data=v.data!==undefined;if(_data)flags|=2;w.uint(flags);w.object(h(v,'peer'));w.int(h(v,'id'));if(_data)w.bytes(v.data);},
'ephemeral.editMessage':function(w,v){w.uint(3483136603);var flags=0;var _message=v.message!==undefined;if(_message)flags|=1;var _entities=v.entities&&v.entities.length;if(_entities)flags|=2;var _replyMarkup=v.replyMarkup!==undefined;if(_replyMarkup)flags|=4;var _media=v.media!==undefined;if(_media)flags|=8;var _richMessage=v.richMessage!==undefined;if(_richMessage)flags|=16;if(v.invertMedia===true)flags|=32;if(v.welcome===true)flags|=64;var _peer=v.peer!==undefined;if(_peer)flags|=128;w.uint(flags);if(_peer)w.object(v.peer);w.object(h(v,'receiverId'));w.int(h(v,'id'));if(_message)w.string(v.message);if(_media)w.object(v.media);if(_entities)w.vector(w.object,v.entities);if(_replyMarkup)w.object(v.replyMarkup);if(_richMessage)w.object(v.richMessage);},
'ephemeral.deleteWelcomeMessage':function(w,v){w.uint(3900877281);w.object(h(v,'peer'));w.int(h(v,'id'));},
'ephemeral.deleteAllWelcomeMessages':function(w,v){w.uint(1934595873);w.object(h(v,'peer'));},
'ephemeral.getWelcomeMessages':function(w,v){w.uint(3684352397);w.object(h(v,'peer'));w.long(h(v,'hash'));},
