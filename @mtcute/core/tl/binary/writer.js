...
'inputRichMessageHTML':function(w,v){w.uint(3572151633);var flags=0;if(v.rtl===true)flags|=1;if(v.noautolink===true)flags|=2;var _photos=v.photos&&v.photos.length;if(_photos)flags|=4;var _documents=v.documents&&v.documents.length;if(_documents)flags|=8;var _users=v.users&&v.users.length;if(_users)flags|=16;w.uint(flags);w.string(h(v,'html'));if(_photos)w.vector(w.object,v.photos);if(_documents)w.vector(w.object,v.documents);if(_users)w.vector(w.object,v.users);},
'inputRichMessageMarkdown':function(w,v){w.uint(162300294);var flags=0;if(v.rtl===true)flags|=1;if(v.noautolink===true)flags|=2;var _photos=v.photos&&v.photos.length;if(_photos)flags|=4;var _documents=v.documents&&v.documents.length;if(_documents)flags|=8;var _users=v.users&&v.users.length;if(_users)flags|=16;w.uint(flags);w.string(h(v,'markdown'));if(_photos)w.vector(w.object,v.photos);if(_documents)w.vector(w.object,v.documents);if(_users)w.vector(w.object,v.users);},
