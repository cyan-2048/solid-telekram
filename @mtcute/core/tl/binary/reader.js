...
391759200:function(r){var flags=r.uint();return{_:'pageBlockPhoto',photoId:r.long(),caption:r.object(),url:flags&1?r.string():void 0,webpageId:flags&1?r.long():void 0,spoiler:!!(flags&2),}},
...
1294139288:function(r){var flags=r.uint();return{_:'webViewResultUrl',fullsize:!!(flags&2),fullscreen:!!(flags&4),queryId:flags&1?r.long():void 0,sameOrigin:!!(flags&8),url:r.string(),}},
...
3572151633:function(r){var flags=r.uint();return{_:'inputRichMessageHTML',rtl:!!(flags&1),noautolink:!!(flags&2),html:r.string(),photos:flags&4?r.vector(r.object):void 0,documents:flags&8?r.vector(r.object):void 0,users:flags&16?r.vector(r.object):void 0,}},
162300294:function(r){var flags=r.uint();return{_:'inputRichMessageMarkdown',rtl:!!(flags&1),noautolink:!!(flags&2),markdown:r.string(),photos:flags&4?r.vector(r.object):void 0,documents:flags&8?r.vector(r.object):void 0,users:flags&16?r.vector(r.object):void 0,}},
