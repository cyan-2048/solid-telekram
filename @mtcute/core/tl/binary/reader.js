...
4248623800:function(r){var flags=r.uint();return{_:'communityForbidden',id:r.int53(),accessHash:flags&8192?r.long():void 0,title:r.string(),}},
1710221652:function(r){var flags=r.uint(),flags2=r.uint();return{_:'community',creator:!!(flags&1),left:!!(flags&4),min:!!(flags&4096),collapsedInDialogs:!!(flags2&1048576),id:r.int53(),accessHash:flags&8192?r.long():void 0,title:r.string(),photo:r.object(),date:r.int(),adminRights:flags&16384?r.object():void 0,defaultBannedRights:flags&262144?r.object():void 0,}},
...
3417810183:function(r){var flags=r.uint();return{_:'communityFull',id:r.int53(),about:r.string(),chatPhoto:r.object(),linkedPeers:r.vector(r.object),adminsCount:flags&2?r.int():void 0,kickedCount:flags&4?r.int():void 0,peerLinkRequestsPending:flags&1?r.int():void 0,}},
...
1562426088:function(r){var flags=r.uint();return{_:'messageActionChangeCommunity',communityId:flags&1?r.int53():void 0,}},
1250688640:function(r){return{_:'messageActionChatJoinedViaCommunity',communityId:r.int53(),}},
...
4153018739:function(r){var flags=r.uint();return{_:'dialogCommunity',pinned:!!(flags&4),communityId:r.int53(),notifySettings:r.object(),}},
...
2081454550:function(r){var flags=r.uint();return{_:'updateEphemeralBotCallbackQuery',queryId:r.long(),userId:r.int53(),peer:flags&1?r.object():void 0,msgId:r.int(),data:r.bytes(),chatInstance:flags&2?r.long():void 0,message:r.object(),}},
1812827683:function(r){var flags=r.uint();return{_:'updateBotStarsSubscription',canceled:!!(flags&1),paymentFailed:!!(flags&2),restored:!!(flags&4),userId:r.int53(),payload:r.bytes(),qts:r.int(),}},
...
3191302553:function(r){return{_:'notifyCommunity',communityId:r.int53(),}},
...
909162586:function(r){var flags=r.uint();return{_:'sendMessageTextDraftAction',canStop:!!(flags&1),keepOnStop:!!(flags&2),randomId:r.long(),text:r.object(),}},
2839005118:function(r){var flags=r.uint();return{_:'inputSendMessageRichMessageDraftAction',canStop:!!(flags&1),keepOnStop:!!(flags&2),randomId:r.long(),richMessage:r.object(),}},
1381386387:function(r){var flags=r.uint();return{_:'sendMessageRichMessageDraftAction',canStop:!!(flags&1),keepOnStop:!!(flags&2),randomId:r.long(),richMessage:r.object(),}},
4227400368:function(r){return{_:'sendMessageStopDraftAction',randomId:r.long(),}},
...
795322159:function(r){var flags=r.uint();return{_:'keyboardButton',style:flags&1024?r.object():void 0,text:r.string(),type:r.object(),}},
...
2245892561:function(r){var flags=r.uint();return{_:'replyKeyboardMarkup',resize:!!(flags&1),singleUse:!!(flags&2),selective:!!(flags&4),persistent:!!(flags&16),forceReply:!!(flags&32),rows:r.vector(r.object),placeholder:flags&8?r.string():void 0,}},
2997966704:function(r){var flags=r.uint();return{_:'replyInlineMarkup',forceReply:!!(flags&32),rows:r.vector(r.object),}},
...
2949094614:function(r){var flags=r.uint();return{_:'textButton',text:r.object(),type:r.object(),style:flags&1?r.object():void 0,}},
...
1724999435:function(r){var flags=r.uint();return{_:'pageBlockBlockquote',collapsed:!!(flags&1),text:r.object(),caption:r.object(),}},
...
3209554562:function(r){var flags=r.uint();return{_:'pageBlockTable',bordered:!!(flags&1),striped:!!(flags&2),compact:!!(flags&4),title:r.object(),rows:r.vector(r.object),}},
...
1835270936:function(r){var flags=r.uint();return{_:'pageBlockButtonRow',alignLeft:!!(flags&1),alignCenter:!!(flags&2),alignRight:!!(flags&4),buttons:r.vector(r.object),}},
955923363:function(r){return{_:'pageBlockDocument',documentId:r.long(),caption:r.object(),}},
...
795199716:function(r){return{_:'dialogPeerCommunity',communityId:r.int53(),}},
...
3920676440:function(r){var flags=r.uint();return{_:'inputInvoiceStarGiftResale',ton:!!(flags&1),showName:!!(flags&4),slug:r.string(),toId:r.object(),message:flags&2?r.object():void 0,}},
...
2078997125:function(r){var flags=r.uint();return{_:'communityPeerRequest',visible:!!(flags&1),peer:r.object(),requestedBy:r.int53(),date:r.int(),}},
...
3386740969:function(r){return{_:'buttonTypeDefault'}},
3745330937:function(r){return{_:'buttonTypeRequestPhone'}},
2616123712:function(r){return{_:'buttonTypeRequestGeoLocation'}},
2865758084:function(r){var flags=r.uint();return{_:'buttonTypeRequestPoll',quiz:flags&1?r.boolean():void 0,}},
1331208759:function(r){var flags=r.uint();return{_:'buttonTypeRequestPeer',buttonId:r.int(),peerType:r.object(),maxQuantity:r.int(),}},
1071802622:function(r){var flags=r.uint();return{_:'inputButtonTypeRequestPeer',nameRequested:!!(flags&1),usernameRequested:!!(flags&2),photoRequested:!!(flags&4),buttonId:r.int(),peerType:r.object(),maxQuantity:r.int(),}},
3222952314:function(r){return{_:'buttonTypeSimpleWebView',url:r.string(),}},
3970234580:function(r){return{_:'inlineButtonTypeUrl',url:r.string(),}},
3218091426:function(r){var flags=r.uint();return{_:'inlineButtonTypeUrlAuth',fwdText:flags&1?r.string():void 0,url:r.string(),buttonId:r.int(),}},
2573319348:function(r){var flags=r.uint();return{_:'inputInlineButtonTypeUrlAuth',requestWriteAccess:!!(flags&1),fwdText:flags&2?r.string():void 0,url:r.string(),bot:flags&4?r.object():void 0,}},
1003140532:function(r){return{_:'inlineButtonTypeWebView',url:r.string(),}},
693484600:function(r){var flags=r.uint();return{_:'inlineButtonTypeCallback',requiresPassword:!!(flags&1),data:r.bytes(),}},
1557360797:function(r){return{_:'inlineButtonTypeGame'}},
1220204453:function(r){return{_:'inlineButtonTypeBuy'}},
2474065909:function(r){var flags=r.uint();return{_:'inlineButtonTypeSwitchInline',samePeer:!!(flags&1),query:r.string(),peerTypes:flags&2?r.vector(r.object):void 0,}},
1067663311:function(r){return{_:'inlineButtonTypeUserProfile',userId:r.int53(),}},
1408487002:function(r){return{_:'inputInlineButtonTypeUserProfile',userId:r.object(),}},
3021812338:function(r){return{_:'inlineButtonTypeCopy',copyText:r.string(),}},
2755158429:function(r){return{_:'inlineButtonTypeDisabled'}},
297902882:function(r){var flags=r.uint();return{_:'keyboardInlineButton',style:flags&1024?r.object():void 0,text:r.string(),type:r.object(),}},
423758582:function(r){return{_:'keyboardInlineButtonRow',buttons:r.vector(r.object),}},
63312061:function(r){var flags=r.uint();return{_:'richButtonStyle',bgPrimary:!!(flags&1),bgDanger:!!(flags&2),bgSuccess:!!(flags&4),link:!!(flags&8),}},
1764381832:function(r){var flags=r.uint();return{_:'pageButton',text:r.object(),type:r.object(),style:flags&1?r.object():void 0,}},
1509940017:function(r){return{_:'ephemeral.welcomeMessagesNotModified'}},
273664114:function(r){return{_:'ephemeral.welcomeMessages',hash:r.long(),messages:r.vector(r.object),}},
3747266572:function(r){return{_:'auth.firebasePnvIntent',nonce:r.string(),digitalCredentialPayload:r.string(),}},
_results:{
